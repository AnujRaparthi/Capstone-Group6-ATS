...
const JobApplication = () => {
    ...
    useEffect(() => {
        const fetchApplication = async () => {
            try {
                ...
                const response = await fetch(`http://capstone-group6-ats-backend.vercel.app/api/job-application/${applicationId}`);
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            ...
            const response = await axios.put(`http://capstone-group6-ats-backend.vercel.app/api/update-application/${applicationId}`, updateData);
